...
use Acme\TutorialBundle\Form\LevelType;
...
class LevelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $levels = $em->getRepository('AcmeTutorialBundle:Level')->findAll();
    ...
    {
        $level = new Level();
        $form = $this->createForm('Acme\TutorialBundle\Form\LevelType', $level);
    ...
    {
        $deleteForm = $this->createDeleteForm($level);
        $editForm = $this->createForm('Acme\TutorialBundle\Form\LevelType', $level);
